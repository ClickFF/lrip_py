...
def submit_jobs(dir_list, work_dir, num_parts, run_command):
    #cwd = os.getcwd()
    ...
    for i in range(1, num_parts + 1):
        ...
        print("Group %s: %s"%(i, new_arrays[i]))
        print(datetime.now())
...
def submit_abcg2_jobs(ligs, num_parts, lig_format, lig_dir_path, top_pose_for_ml):
    #cwd = os.getcwd()
